...
# Django settings for remotemanager project.
...
ADMINS = (
    # ('Damien Dando', 'damien.d.09@gmail.com'),
)
...
#        'NAME': '/data/remotemanager.db',
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'remotemanagerdb',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/srv/remotemanager/static/'
...
STATICFILES_DIRS = (
    '/srv/remotemanager/main_app/static',
...
SECRET_KEY = 'u(f$z+e0r@8388yt(wvy#bqns(0#fr3fgmbi#c&-92_wvq=0^l'
...
LOCALE_PATHS = (
    '/srv/remotemanager/main_app/locale/',
)
...
ROOT_URLCONF = 'remotemanager.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'remotemanager.wsgi.application'
